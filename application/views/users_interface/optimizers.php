		...
		<div class="row smaller">
			<div class="span12">
				...
				<div style="margin-top:40px;">
					<b>Регистрация временно недоступна.</b> Обращайтесь на контактный ящик <?=safe_mailto('admin@bystropost.ru','admin@bystropost.ru');?>, укажите тему письма "Работа оптимизатором"
				</div>
			</div>
		</div>
