		...
		<div class="modal-body">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-prepend input-append">
							<span class="add-on">руб</span><input type="text" class="input-small asvinput digital" placeholder="" name="wprice"><span class="add-on">.00</span>
						</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<div class="input-prepend input-append">
							<span class="add-on">руб</span><input type="text" class="input-small asvinput digital" placeholder="" name="mprice"><span class="add-on">.00</span>
						</div>
						<div class="help-inline" style="display:none;">&nbsp;</div>
					</div>
				</div>
