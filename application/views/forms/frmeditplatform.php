<?=form_open($this->uri->uri_string(),array('id'=>'frmaddplatform')); ?>
	...
	<?php endfor;?>
		...
		<tr>
			...
			<td>
				<span style="margin-left:10px;"><strong>Ширина изображения:</strong></span><input name="imgwidth" class="reg-form-input w50 digital imgsize" type="text" value="<?=$platform['imgwidth']?>" style="margin-left:10px; color:#00ca00"><br/>
				<span style="margin-left:15px;"><strong>Высота изображения:</strong></span><input name="imgheight" type="text" class="reg-form-input w50 digital imgsize" value="<?=$platform['imgheight']?>" style="margin-left:10px; color:#00ca00"><br/>
