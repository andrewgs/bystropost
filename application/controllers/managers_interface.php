...
class Managers_interface extends CI_Controller{
	...
	public function control_mails(){
		...
		$pagevar = array(
					'description'	=> '',
					'author'		=> '',
					'title'			=> 'Кабинет Менеджера | Управление входящими сообщениями',
					'baseurl' 		=> base_url(),
					'loginstatus'	=> $this->loginstatus['status'],
					'userinfo'		=> $this->user,
	...
	public function control_reply_mail(){
		...
		$pagevar = array(
					'description'	=> '',
					'author'		=> '',
					'title'			=> 'Кабинет Менеджера | Отправка сообщения',
					'baseurl' 		=> base_url(),
					'loginstatus'	=> $this->loginstatus['status'],
					'userinfo'		=> $this->user,
					'mltext'		=> $mail['text'],
		...
		$this->load->view("managers_interface/control-reply-mail",$pagevar);
	}
	...
	public function control_platforms(){
		...
		$pagevar = array(
					'description'	=> '',
					'author'		=> '',
					'title'			=> 'Кабинет Менеджера | Управление площадками',
					'baseurl' 		=> base_url(),
					'loginstatus'	=> $this->loginstatus['status'],
					'userinfo'		=> $this->user,
	...
	public function control_add_platform(){
		...
		$pagevar = array(
					'description'	=> '',
					'author'		=> '',
					'title'			=> 'Кабинет Менеджера | Управление площадками | Добавление площадки',
					'baseurl' 		=> base_url(),
					'loginstatus'	=> $this->loginstatus['status'],
					'userinfo'		=> $this->user,
		...
		$this->load->view("managers_interface/control-add-platform",$pagevar);
	}
	...
	public function control_edit_platform(){
		...
		$pagevar = array(
					'description'	=> '',
					'author'		=> '',
					'title'			=> 'Кабинет Менеджера | Управление площадками | Редактирование площадки',
					'baseurl' 		=> base_url(),
					'loginstatus'	=> $this->loginstatus['status'],
					'userinfo'		=> $this->user,
	...
	public function control_tickets(){
		...
		$pagevar = array(
					'description'	=> '',
					'author'		=> '',
					'title'			=> 'Кабинет Менеджера | Управление тикетами',
					'baseurl' 		=> base_url(),
					'loginstatus'	=> $this->loginstatus['status'],
					'userinfo'		=> $this->user,
					'platforms'		=> $this->mdplatforms->count_records_by_webmaster($this->user['uid']),
		...
		$this->load->view("managers_interface/control-tickets",$pagevar);
	}
	...
	public function control_view_ticket(){
		...
		$pagevar = array(
					'description'	=> '',
					'author'		=> '',
					'title'			=> 'Кабинет Менеджера | Управление тикетами | Просмотр тикета',
					'baseurl' 		=> base_url(),
					'loginstatus'	=> $this->loginstatus['status'],
					'userinfo'		=> $this->user,
		...
		$this->load->view("managers_interface/control-view-ticket",$pagevar);
	}
	...
	public function control_reply_ticket(){
		...
		$this->load->view("managers_interface/control-reply-ticket",$pagevar);
	}
